...
namespace MiChatbotBlazor.Migrations
{
    ...
    [Migration("20250713001912_InitialCreate")]
            ...
            modelBuilder.Entity("MiChatbotBlazor.Data.Models.ChatMessage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Sender = "bot",
                            SessionId = 1,
                            Timestamp = new DateTime(2025, 7, 13, 0, 19, 11, 863, DateTimeKind.Utc).AddTicks(5652)
                        });
                });
            ...
            modelBuilder.Entity("MiChatbotBlazor.Data.Models.ChatSession", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 7, 13, 0, 19, 11, 863, DateTimeKind.Utc).AddTicks(2044),
                            IsActive = true,
                            Title = "Conversación de Demo",
                            UpdatedAt = new DateTime(2025, 7, 13, 0, 19, 11, 863, DateTimeKind.Utc).AddTicks(1671),
                            UserId = "demo"
                        });
                });
